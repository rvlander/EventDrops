...
module.exports = function (d3, document) {
  ...
  return function eventDrops(config) {
        ...
        var eventLine = require('./eventLine')(d3, ctx, base);
        ...
        function zoomStart() {
          ...
          ctx.clearRect(topX, topY, topX + canvas.node().width, topY + canvas.node().height);
  			  ...
  			  lines.enter()
    				...
    				.call(eventLine({ xScale: xScale, yScale: yScale, eventLineColor: config.eventLineColor, eventColor: config.eventColor }))
  			  ;
